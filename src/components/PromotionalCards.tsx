    ...
    <div className="py-8 md:py-12 bg-white">
      <div className="container mx-auto px-4 md:px-0">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Card 1 */}
          <div className="border border-gray-200 rounded-lg p-4 md:p-6 bg-white shadow-sm flex flex-col">
            <div className="mb-4">
            ...
            <h3 className="text-lg md:text-xl font-medium mb-1">Earn a $200 cash rewards bonus</h3>
            <p className="text-gray-700 mb-4 text-sm flex-grow">Plus, earn unlimited 2% cash rewards on purchases with $0 annual fee. Terms apply.</p>
          ...
          <div className="border border-gray-200 rounded-lg p-4 md:p-6 bg-white shadow-sm flex flex-col">
            ...
            <h3 className="text-lg md:text-xl font-medium mb-1">Want a $125 checking bonus?</h3>
            <p className="text-gray-700 mb-4 text-sm flex-grow">Open a new Clear Access Banking account and complete the qualifying requirements</p>
            <div className="flex items-center text-indigo-600 font-medium mt-auto">
              <span>Learn more</span>
              <ChevronRight size={16} className="ml-1" />
            </div>
          ...
          <div className="border border-gray-200 rounded-lg p-4 md:p-6 bg-white shadow-sm flex flex-col">
            ...
            <h3 className="text-lg md:text-xl font-medium mb-1">Open a savings account</h3>
            <p className="text-gray-700 mb-4 text-sm flex-grow">Explore our savings accounts and find the right fit for you</p>
            <div className="flex items-center text-indigo-600 font-medium mt-auto">
          ...
          <div className="border border-gray-200 rounded-lg p-4 md:p-6 bg-white shadow-sm flex flex-col">
            ...
            <h3 className="text-lg md:text-xl font-medium mb-1 flex-grow">Interest rates today</h3>
            <div className="flex items-center text-indigo-600 font-medium mt-auto">
